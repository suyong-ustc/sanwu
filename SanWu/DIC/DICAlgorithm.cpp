...
bool PseudoInverseMatrix(const mat& gx, const mat& gy, const mat& x, const mat& y, const vec& w, const int& order, mat& pseudo)
{
	...
	//else if (order == 3)
	//	ok = ThirdOrderPseudoInverseMatrix(gx, gy, x, y, w, pseudo);
	//else if (order == 4)
	//	ok = FourthOrderPseudoInverseMatrix(gx, gy, x, y, w, pseudo);
	//else if (order == 5)
	//	ok = FifthOrderPseudoInverseMatrix(gx, gy, x, y, w, pseudo);
...
//
//bool ThirdOrderPseudoInverseMatrix(const mat& gx, const mat& gy, const mat& x, const mat& y, const mat& weight, mat& pseudo)
//{
//	// 雅可比矩阵
...
//
//	// 海森矩阵
//	const mat hessian = jacobian.t() * weight * jacobian;
//
//	// 伪逆矩阵
//	pseudo = inv_sympd(hessian) * jacobian.t() * weight;
//
//	return true;
//}
//
//
//
//bool FourthOrderPseudoInverseMatrix(const mat& gx, const mat& gy, const mat& x, const mat& y, const mat& weight, mat& pseudo)
//{
//	// 雅可比矩阵
...
//
//
//bool FifthOrderPseudoInverseMatrix(const mat& gx, const mat& gy, const mat& x, const mat& y, const mat& weight, mat& pseudo)
//{
//	// 雅可比矩阵
