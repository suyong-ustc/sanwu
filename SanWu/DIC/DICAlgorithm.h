...
bool PseudoInverseMatrix(const arma::mat& gx, const arma::mat& gy, const arma::mat& x, const arma::mat& y, const arma::vec& weight, const int& order, arma::mat& pseudo);

bool ZeroOrderPseudoInverseMatrix(const arma::mat& gx, const arma::mat& gy, const arma::mat& x, const arma::mat& y, const arma::vec& weight, arma::mat& pseudo);

bool FirstOrderPseudoInverseMatrix(const arma::mat& gx, const arma::mat& gy, const arma::mat& x, const arma::mat& y, const arma::vec& weight, arma::mat& pseudo);

bool SecondOrderPseudoInverseMatrix(const arma::mat& gx, const arma::mat& gy, const arma::mat& x, const arma::mat& y, const arma::vec& weight, arma::mat& pseudo);

//bool ThirdOrderPseudoInverseMatrix(const arma::mat& gx, const arma::mat& gy, const arma::mat& x, const arma::mat& y, const arma::mat& weight, arma::mat& pseudo);
//
//bool FourthOrderPseudoInverseMatrix(const arma::mat& gx, const arma::mat& gy, const arma::mat& x, const arma::mat& y, const arma::mat& weight, arma::mat& pseudo);
//
//bool FifthOrderPseudoInverseMatrix(const arma::mat& gx, const arma::mat& gy, const arma::mat& x, const arma::mat& y, const arma::mat& weight, arma::mat& pseudo);
...
double NormalizeVectorize(const arma::mat& m, const arma::mat& w, arma::vec& v);

double ZNCC(const arma::mat& a, const arma::mat& b);

double ZNCC(const arma::mat& a, const arma::mat& b, const arma::mat& w);